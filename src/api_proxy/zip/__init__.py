# -*- coding: utf-8 -*-
"""
READ FIRST: This module is a fork of https://github.com/allanlei/python-zipstream/blob/master/zipstream/__init__.py
The only difference is our modified version decouples the ZipInfo (file header) writing, and the rest of the content.
This is to allow accessing the zip header before writing the rest of the content (as header is independent of the content)
...
class ZipFile(zipfile.ZipFile):
    ...
    def write_header(self, arcname, compress_type) -> Tuple[str, ZipInfo]:
        ...
        return self.fp.write(zinfo.FileHeader(zip64)), zinfo

    def write_content(self, iterable, zinfo):
        zip64 = self._allowZip64 and \
                zinfo.file_size * 1.05 > ZIP64_LIMIT
